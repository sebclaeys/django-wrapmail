...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.steps'
        db.delete_column(u'mailator_task', 'steps')

        # Deleting field 'Task.progress'
        db.delete_column(u'mailator_task', 'progress')

        # Adding field 'Task.step'
        db.add_column(u'mailator_task', 'step',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=100),
                      keep_default=False)

        # Adding field 'Task.processed'
        db.add_column(u'mailator_task', 'processed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Task.growth'
        db.add_column(u'mailator_task', 'growth',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


        # Changing field 'Task.datetime'
        db.alter_column(u'mailator_task', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'Recipient.spam'
        db.add_column(u'mailator_recipient', 'spam',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Recipient.bounce'
        db.add_column(u'mailator_recipient', 'bounce',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Recipient.open'
        db.add_column(u'mailator_recipient', 'open',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Recipient.click'
        db.add_column(u'mailator_recipient', 'click',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding index on 'Recipient', fields ['email']
        db.create_index(u'mailator_recipient', ['email'])

        # Adding field 'EmailList.spam'
        db.add_column(u'mailator_emaillist', 'spam',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EmailList.bounce'
        db.add_column(u'mailator_emaillist', 'bounce',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EmailList.open'
        db.add_column(u'mailator_emaillist', 'open',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EmailList.click'
        db.add_column(u'mailator_emaillist', 'click',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding index on 'EmailItem', fields ['email']
        db.create_index(u'mailator_emailitem', ['email'])


    def backwards(self, orm):
        # Removing index on 'EmailItem', fields ['email']
        db.delete_index(u'mailator_emailitem', ['email'])

        # Removing index on 'Recipient', fields ['email']
        db.delete_index(u'mailator_recipient', ['email'])

        # Adding field 'Task.steps'
        db.add_column(u'mailator_task', 'steps',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Task.progress'
        db.add_column(u'mailator_task', 'progress',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Task.step'
        db.delete_column(u'mailator_task', 'step')

        # Deleting field 'Task.processed'
        db.delete_column(u'mailator_task', 'processed')

        # Deleting field 'Task.growth'
        db.delete_column(u'mailator_task', 'growth')


        # Changing field 'Task.datetime'
        db.alter_column(u'mailator_task', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'Recipient.spam'
        db.delete_column(u'mailator_recipient', 'spam')

        # Deleting field 'Recipient.bounce'
        db.delete_column(u'mailator_recipient', 'bounce')

        # Deleting field 'Recipient.open'
        db.delete_column(u'mailator_recipient', 'open')

        # Deleting field 'Recipient.click'
        db.delete_column(u'mailator_recipient', 'click')

        # Deleting field 'EmailList.spam'
        db.delete_column(u'mailator_emaillist', 'spam')

        # Deleting field 'EmailList.bounce'
        db.delete_column(u'mailator_emaillist', 'bounce')

        # Deleting field 'EmailList.open'
        db.delete_column(u'mailator_emaillist', 'open')

        # Deleting field 'EmailList.click'
        db.delete_column(u'mailator_emaillist', 'click')
