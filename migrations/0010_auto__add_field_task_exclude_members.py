...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.exclude_members'
        db.add_column(u'mailator_task', 'exclude_members',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.exclude_members'
        db.delete_column(u'mailator_task', 'exclude_members')
