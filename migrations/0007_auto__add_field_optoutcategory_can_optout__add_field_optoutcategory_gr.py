...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OptoutCategory.can_optout'
        db.add_column(u'mailator_optoutcategory', 'can_optout',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'OptoutCategory.group'
        db.add_column(u'mailator_optoutcategory', 'group',
                      self.gf('django.db.models.fields.CharField')(default='trampolinn', max_length=32, db_index=True),
                      keep_default=False)

        # Adding field 'OptoutCategory.link_override'
        db.add_column(u'mailator_optoutcategory', 'link_override',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OptoutCategory.can_optout'
        db.delete_column(u'mailator_optoutcategory', 'can_optout')

        # Deleting field 'OptoutCategory.group'
        db.delete_column(u'mailator_optoutcategory', 'group')

        # Deleting field 'OptoutCategory.link_override'
        db.delete_column(u'mailator_optoutcategory', 'link_override')
