...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.attachment'
        db.add_column(u'mailator_template', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.attachment'
        db.delete_column(u'mailator_template', 'attachment')
