...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mailator_type', 'description', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Type.email_from'
        db.alter_column(u'mailator_type', 'email_from', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Type.description'
        db.alter_column(u'mailator_type', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Type.email_from'
        db.alter_column(u'mailator_type', 'email_from', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
