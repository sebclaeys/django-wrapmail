...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailList.nb_emails'
        db.add_column(u'mailator_emaillist', 'nb_emails',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailList.nb_emails'
        db.delete_column(u'mailator_emaillist', 'nb_emails')
