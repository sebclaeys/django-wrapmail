...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.concurrency'
        db.add_column(u'mailator_task', 'concurrency',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.concurrency'
        db.delete_column(u'mailator_task', 'concurrency')
    ...
    models = {
        ...
        'mailator.task': {
            ...
            'concurrency': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
        ...
        'mailator.template': {
            ...
            'attachment': ('django.db.models.fields.files.FileField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
