...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Task'
        db.create_table(u'mailator_task', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='Manual send', max_length=64)),
            ('lang', self.gf('django.db.models.fields.CharField')(default='en', max_length=4)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('connection_override', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mailator.Connection'], null=True)),
            ('liste', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailator.EmailList'])),
            ('email', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailator.Type'])),
            ('logs', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('steps', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ...
            ('schedule', self.gf('django.db.models.fields.CharField')(default=u'none', max_length=30, db_index=True)),
            ('errors', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('mailator', ['Task'])


    def backwards(self, orm):
        # Deleting model 'Task'
        db.delete_table(u'mailator_task')
    ...
    models = {
        ...
        'mailator.task': {
            ...
            'connection_override': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['mailator.Connection']", 'null': 'True'}),
