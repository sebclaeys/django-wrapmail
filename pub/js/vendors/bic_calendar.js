...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function() {
        ...
        function showCalendar() {
            ...
            var nextMonthButton = $('<td><a href="#" class="button-month-next"><i class="fa fa-arrow-right" ></i></a></td>');
            //event
            ...
            var previousMonthButton = $('<td><a href="#" class="button-month-previous"><i class="fa fa-arrow-left" ></i></a></td>');
            //event
            ...
            var nextYearButton = $('<td><a href="#" class="button-year-next"><i class="fa fa-arrow-right" ></i></a></td>');
            //event
            ...
            var previousYearButton = $('<td><a href="#" class="button-year-previous"><i class="fa fa-arrow-left" ></i></a></td>');
            //event
